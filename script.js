...
(function () {
	...
	let
			...
			plugins = {
				...
				particles:               document.querySelectorAll('.particles-js'),
	...
	$(function () {
		...
		if ( plugins.particles.length ) {
			for (let i = 0; i < plugins.particles.length; i++) {
				let options = plugins.particles[i].getAttribute( 'data-particles-json' ) || {};
				particlesJS.load( plugins.particles[i].id, options );
			}
		}
